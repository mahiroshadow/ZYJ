...
def image_cut(img_pth,save_pth):
    ...
    left_eye_crop=img[int(landmarks[19][1]-0.25*le_h):int(landmarks[27][1]-0.05*le_h),
    ...
    right_eye_crop=img[int(landmarks[24][1]-0.25*re_h):int(landmarks[44][1]-0.05*re_h),
    ...
    mouse_crop=img[int(landmarks[51][1]-0.5*m_h):int(landmarks[57][1]+0.35*m_h),
           int(landmarks[48][0]-0.25*m_l):int(landmarks[54][0]+0.25*m_h)]
    mouse_crop=cv2.resize(mouse_crop,(left_eye_crop.shape[1]+right_eye_crop.shape[1],mouse_crop.shape[0]*2))
    width=left_eye_crop.shape[1]+right_eye_crop.shape[1]
    ...
    new_img[0:height-mouse_crop.shape[0],left_eye_crop.shape[1]:width,:]=right_eye_crop[0:height-mouse_crop.shape[0],:,:]
